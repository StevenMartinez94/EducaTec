<template>
  <main>
    ...
    <hr>
		...
		<p class="intro">Informalmente algo variable es algo que puede cambiar de un momento a otro. Técnicamente una
...
se declare de tipo real podrá almacenar solamente datos de tipo real.</p>
<p><strong>Tipo Caracter:</strong>Un dato tipo carácter es un equivalente del Código ASCII ( American Standard Code for
...
código interno para la interpretación de todas y cada una de las teclas (de su teclado, obviamente).</p>
<h3>¿Cómo se llevan los datos a las variables?</h3>
<p>Pues a través de un signo muy conocido por usted y es el signo =. Este signo tiene, en el caso de los
...
una variable y al lado derecho del igual puede haber una constante, una variable ó una expresión.</p>
<img src="../../public/variables-asignacion.png" alt="">
<p>Puede notarse en este ejemplo que en la variable a se ha almacenado una constante, en la
...
<p>De acuerdo a lo dicho vamos a resolver el siguiente conjunto de instrucciones:</p>
<img src="../../public/asignaciones-resueltas.png" alt="">
<h3>Operadores</h3>
<p>Los operadores son signos que nos permiten expresar relaciones entre variables y/o constantes,
...
computacional también se pueden utilizar los siguientes operadores: "^" Para expresar la potenciación,  "*" Para expresar la multiplicación,  "/" Para expresar la división</p>
<p>Algo que debemos tener en cuenta cuando vamos a escribir una expresión es que el computador
solo entiende las expresiones en formato linealizado esto quiere decir escritas en una sola línea.
De tal manera que si queremos escribir la ecuación</p>
